    ...
    >
      ...
      <div
        className={cn(
          ...
          isCollapsed ? "max-h-14 opacity-100 translate-y-0" : "max-h-0 opacity-0 -translate-y-1 pointer-events-none",
        )}
      >
        {collapsedSummary ? (
          <div className="rounded-md border border-border/70 bg-background/90 px-3 py-1.5 text-xs">
