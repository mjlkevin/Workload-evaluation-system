...
| `web-search`    | 实时信息及互联网检索工具。价格与可用性详情请见 [联网搜索价格](/pricing/tools) |
| `rethink`       | 智能整理想法工具                                         |
...
## 调用 web\_search 官方工具的示例

以下是一个 python 示例，以 web\_search 官方工具为例，展示了如何通过 Kimi API 调用官方工具：

您也可以通过 Kimi 开发工作台来交互式体验 Kimi 模型和工具的能力，[前往开发工作台](https://platform.kimi.com/playground)
...
如 [3214567是素数吗? 一个 Tool Calls 的调用案例介绍](/api/tool-use)，这儿有几个关键的信息我们需要让 Formula API 和模型对齐。
