...
const NAV_ITEMS = [
  ...
  { href: 'runtime.html', label: 'AI 任务执行' },
  { href: 'plan.html', label: '计划与进度' },
  { href: 'testing.html', label: '测试与验收' },
  { href: 'monitoring.html', label: '监控与审计' },
  { href: 'risks.html', label: '风险与决策' },
  { href: 'changes.html', label: '变更记录' },
  { href: 'sources.html', label: '信息来源' },
  { href: 'collaboration-protocol.html', label: '多 AI 协作' },
  { href: 'branches.html', label: '开发分支' },
