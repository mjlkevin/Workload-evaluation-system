...
> 🛠️ **阶段 2 存储切换已于 2026-08-31 收官（九个域运行时读写全部落 PostgreSQL）；阶段 3 的测试与扫描防护链四批已闭环，其余遗留无紧急项、按触发条件等待**——接手前请先读 [`AGENTS.md`](AGENTS.md) 与当前进展看板 [`03_技术设计/系统架构/WES-Agent-升级总看板/index.html`](03_技术设计/系统架构/WES-Agent-升级总看板/index.html)。
